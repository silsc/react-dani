...
const Guia2Form = () => {
    ...
    useEffect(() => {
        ...
        window['ml_webform_success_3781311'] = f;
    ...
    return (
        <>
            <div id="mlb2-3781311" className="ml-form-embedContainer ml-subscribe-form ml-subscribe-form-3781311">
                <div>
                    ...
                    <div className="ml-form-embedBody ml-form-embedBodyDefault row-form" style={displayForm ? {display: "block"} : {display: "none"}}>
                        ...
                        <div className="ml-form-embedContent" >
                            ...
                            <p>{t("campaign2.text")}</p>
                        
                        </div>

                        <form className="ml-block-form" action="https://assets.mailerlite.com/jsonp/347959/forms/81466336691095509/subscribe" data-code="" method="post" target="_blank">
                            <div className="ml-form-formContent">
                                ...
                                <div className='checkbox'>
                                    ...
                                    <label for="privacy">{t("campaign2.privacy")}</label>
                                </div>
                            ...
                            <div className="ml-form-embedSubmit">
                                ...
                                <button type="submit" className="primary" disabled={validateInput([email])} > {t("campaign2.send")}</button>
                                
                                <button disabled="disabled" style={{display: "none"}} type="button" className="loading">
                                <div className="ml-form-embedSubmitLoad"></div>
                                <span className="sr-only">{t("campaign2.sending")}</span>
                                </button>
                            </div>
                    ...
                    <div className="ml-form-successBody row-success" style={ displaySuccess ? {display: "block"} : {display: "none"}}>
                        ...
                        <div className="ml-form-successContent">
                            ...
                            <h4>{t("campaign2.sent-1")}</h4>
                            
                            <p>{t("campaign2.sent-2")}</p>

                            <Link to="/" className='link-web'>{t("campaign2.goback")}</Link>
