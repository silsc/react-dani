...
class Player extends React.Component {
  state = {
    ...
    currentTime: '0:00',
    musicList: [
      {name:'La Realidad', author: 'The Fox 196', img: audio1Img, audio: audio1 , duration: '0:47', type: `${this.props.t('work.production')} / ${this.props.t('work.mix')} / ${this.props.t('work.master')} `}, 
      ...
      {name:'Shadow Of Your Bliss', author: 'It Came From The Void', img: audio4Img, audio: audio4, duration: '0:41', type: `${this.props.t('work.production')} / ${this.props.t('work.mix')} / ${this.props.t('work.master')}`},
