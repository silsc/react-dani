...
const Work = React.forwardRef((props, ref) => {
  ...
  return (
    <section
      ref={ref}
      className={`work section ${props.inView ? "theme--dark" : "theme--default"}`}
      id="work"
    >
        ...
        <div className="work-info">
          <Fade cascade triggerOnce delay={200}>
            ...
            <p>
              ...
              {t("work.text-3")}{" "}
              <span
                className="cursor spotify-green bold"
                onClick={() =>
                  openInNewTab(
                    "https://open.spotify.com/playlist/2nwVcowWfYhXXqkmVgGVNK?si=586a412f544a44e7&nd=1",
                  )
                }
              >
                {t("work.cta-2")}{" "}
